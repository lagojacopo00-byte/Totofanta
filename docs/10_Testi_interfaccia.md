...
## Classifica apribile — in fondo alla pagina torneo

File: `src/app/play/(app)/[tournamentId]/standings-list.tsx`

- `[CLASSIFICA-TITOLO]`: "Classifica"
- `[CLASSIFICA-APRI]`: "tocca per la giornata {N}" — solo quando c'è una giornata aperta
- `[CLASSIFICA-SLOT-VIVI]`: "{vivi}/{totali} vivi"
- `[CLASSIFICA-ELIMINATO]`: "eliminato" — solo a torneo concluso
